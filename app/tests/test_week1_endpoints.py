...
DEFAULT_DATABASE_URL = "postgresql+asyncpg://postgres:postgres@localhost:5432/hireai"
DATABASE_URL = os.getenv("TEST_DATABASE_URL") or os.getenv("DATABASE_URL", DEFAULT_DATABASE_URL)
